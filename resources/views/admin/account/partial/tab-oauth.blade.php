<div class="tab-pane" id="tab_1_4">
	<form action="#">
			...
			<tr>
				...
				<td>
					<div class="mt-radio-inline">
						<label class="mt-radio"> <input type="radio" name="optionsRadios1"
							value="option1" /> Yes <span></span>
						</label> <label class="mt-radio"> <input type="radio"
							name="optionsRadios1" value="option2" checked /> No <span></span>
						</label>
					</div>
				</td>
			</tr>
				...
				<td>
					<div class="mt-radio-inline">
						<label class="mt-radio"> <input type="radio"
							...
							name="optionsRadios11" value="option2" checked /> No <span></span>
						</label>
					</div>
				</td>
			</tr>
				...
				<td>
					<div class="mt-radio-inline">
						<label class="mt-radio"> <input type="radio"
							...
							name="optionsRadios21" value="option2" checked /> No <span></span>
						</label>
					</div>
				</td>
			</tr>
				...
				<td>
					<div class="mt-radio-inline">
						<label class="mt-radio"> <input type="radio"
							...
							name="optionsRadios31" value="option2" checked /> No <span></span>
						</label>
					</div>
				</td>
			</tr>
		...
		<div class="margin-top-10">
			<a href="javascript:;" class="btn red"> Save Changes </a> <a
