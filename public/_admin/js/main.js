...
requirejs.config({
	...
	paths: {
		...
		waypoints: 'https://cdn.bootcss.com/waypoints/4.0.1/jquery.waypoints.min',
		...
		daterangepicker_moment : 'https://cdn.bootcss.com/bootstrap-daterangepicker/3.0.3/moment.min',
		//editable
		...
		//bootstrapTable
		bootstrapTable : 'https://cdn.bootcss.com/bootstrap-table/1.12.2/bootstrap-table.min',
		//editable
		bootstrapTableEditable : 'https://cdn.bootcss.com/bootstrap-table/1.12.2/extensions/editable/bootstrap-table-editable',
		//export
		bootstrapTableExport : '../../vendor/bootstrap-table-master/extensions/export/bootstrap-table-export',
		xlsx 	: '../../vendor/tableExport.jquery.plugin/libs/js-xlsx/xlsx.core.min',
		blobjs 	: '../../vendor/Blob.js/Blob.min',
		'file-saverjs' 	: '../../vendor/tableExport.jquery.plugin/libs/FileSaver/FileSaver.min',
		'tableexport' 	: '../../vendor/tableExport.jquery.plugin/tableExport',
		
		//pick area
		pickArear : '../../vendor/pick-arear/pick-pcc.min.1.0.1',
		// area
		area : '../../vendor/area',
	},
...
//				'css!https://cdn.bootcss.com/dropzone/5.5.1/min/dropzone.min',
		...
		pickArear: {
			deps: [
				'jquery',
				'css!../../vendor/pick-arear/pick-pcc.min.1.0.1',
			],
		},
